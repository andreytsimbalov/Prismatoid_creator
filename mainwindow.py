...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2.clicked.connect(self.ch_obt)
    ...
    def ch_obt(self,a):
        self.openGLWidget.miagko=not(self.openGLWidget.miagko)
        self.openGLWidget.changeFigeru()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Изменить обтекаемость клеток"))
